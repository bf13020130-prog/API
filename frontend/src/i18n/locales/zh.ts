export default {
  ...
  nav: {
    ...
    channelPricing: '渠道定价',
    channelMonitor: '渠道监控',
    adapterOperations: '适配器运营',
    adapterProviders: '适配器诊断',
    channelStatus: '渠道状态',
    riskControl: '风控中心',
  },
  ...
  dashboard: {
    ...
    balance: '余额',
    accountCredits: '账户额度',
    accountCreditsHint: '余额、消耗与当前请求态势',
    redeemTopUp: '兑换充值',
    balanceBase: '余额基数',
    used: '已使用',
    systemAnnouncements: '系统公告',
    systemAnnouncementsHint: '最新站内消息和运营提示',
    noAnnouncements: '暂无公告',
    noAnnouncementsHint: '系统运行正常，新的消息会显示在这里。',
    modelSquare: '模型广场',
    modelSquareHint: '查看可用渠道、模型与接入方式',
    inviteRebate: '邀请返佣',
    inviteRebateHint: '分享邀请链接，好友使用后获得返利',
    redeemRecharge: '兑换充值',
    redeemRechargeHint: '输入兑换码，额度即时到账',
    apiKeys: 'API 密钥',
    todayRequests: '今日请求',
    todayCost: '今日消费',
  ...
  admin: {
    ...
    adapterProviders: {
      title: '适配器供应商',
      description: '管理 DB 中的长尾适配器供应商，并查看生效状态和路由激活列表。核心供应商仍由 sub2api 原生能力接管。',
      observeOnly: '观察模式',
      enforced: '强制模式',
      enforcementEnabled: '已启用强制路由',
      enforcementDisabled: '强制路由关闭',
      createProvider: '新建供应商',
      editProvider: '编辑供应商',
      deleteTitle: '删除适配器供应商',
      deleteConfirm: '确定删除“{name}”？已关联的路由策略会阻止删除。',
      created: '适配器供应商已创建',
      updated: '适配器供应商已更新',
      saveFailed: '保存适配器供应商失败',
      deleteFailed: '删除适配器供应商失败',
      providerNotFound: '未找到对应的适配器供应商',
      invalidJson: 'JSON 格式无效',
      totalConfigured: '已配置',
      activeConfigured: '已激活',
      disabledConfigured: '已停用',
      invalidConfigured: '配置异常',
      activeSlugs: '路由激活 Slug',
      activeSlugsHint: '只有有效且 active 的长尾供应商会进入 CapabilityRouter。',
      noActiveSlugs: '暂无激活的适配器 slug',
      enabled: '启用',
      disabled: '停用',
      invalid: '异常',
      reasonEnabled: '已进入适配器路由候选',
      reasonDisabled: '供应商已停用',
      ...
      operator: {
        ...
        activePolicies: '启用策略',
        recentFailures: '近期失败',
        streamFinalized: '流式结算',
        websocketTraffic: 'WebSocket',
        costToday: '累计成本',
        readyRoutes: '可路由供应商',
        noIssues: '运行正常',
        needsAttention: '需要关注',
        focusRequests: '筛选请求审计：{metric}'
      },
      usage: {
        totalRequests: '适配器请求',
        successRate: '成功率',
      ...
      form: {
        ...
        credentials: '凭据 JSON',
        credentialsKeepPlaceholder: '留空则保留现有凭据',
        existingCredentialKeys: '现有凭据键：{keys}',
        extra: '扩展 JSON',
        capabilitiesRequired: '请至少填写一个能力',
        objectJsonRequired: '{field} 必须是 JSON 对象'
      },
      routePolicies: {
        title: '路由策略',
        description: '配置长尾能力进入适配器的显式策略；默认停用，核心供应商平台不能路由到适配器。',
        createPolicy: '新建策略',
        editPolicy: '编辑策略',
        created: '路由策略已创建',
        updated: '路由策略已更新',
        ...
        emptyTitle: '暂无路由策略',
        emptyDescription: '当前还没有显式路由策略，网关仍保持观察模式。',
        columns: {
          policy: '策略',
          match: '匹配',
          target: '目标'
        ...
        form: {
          matchMethod: '匹配方法',
          matchPath: '匹配路径',
          matchCapability: '匹配能力',
          matchModel: '匹配模型',
          matchGroupPlatform: '匹配分组平台',
          target: '目标',
          adapterProvider: '适配器供应商',
          priority: '优先级',
          description: '描述',
          conditions: '条件 JSON'
        }
      ...
      requests: {
        title: '适配器请求审计',
        description: '查看最近进入长尾适配器的请求、响应状态、耗时和扣费写入结果。',
        allProviders: '全部供应商',
        allStatus: '全部状态',
        success: '成功',
        failed: '失败',
        searchRequest: '搜索 request_id',
        loadFailed: '加载适配器请求失败',
        billingApplied: '已扣费',
        billingSkipped: '未扣费',
        billingError: '扣费异常',
        window24h: '近 24 小时',
        ...
        loadedTotalCount: '已加载 {count} / 共 {total} 条',
        loadMore: '加载更多',
        ...
        markers: {
          streamFinalized: '流式结算',
          websocketFinalized: 'WS结算',
          websocketTunnel: 'WS通道'
        },
        emptyTitle: '暂无适配器请求',
        emptyDescription: '当前还没有命中长尾适配器的请求记录。',
        columns: {
          request: '请求',
          provider: '供应商',
          status: '状态',
