export default {
  ...
  nav: {
    ...
    adapterProviders: 'Adapter Diagnostics',
  ...
  dashboard: {
    ...
    accountCreditsHint: 'Balance, spending, and current request signals',
    redeemTopUp: 'Redeem',
    balanceBase: 'Balance Base',
    used: 'Used',
    systemAnnouncements: 'System Announcements',
    systemAnnouncementsHint: 'Latest site messages and service notes',
    noAnnouncements: 'No announcements',
    noAnnouncementsHint: 'System is operating normally. New messages will appear here.',
    modelSquare: 'Model Square',
    modelSquareHint: 'View available channels, models, and integration notes',
    inviteRebate: 'Invite Rebates',
    inviteRebateHint: 'Share your invite link and earn rebates when friends use it',
    redeemRecharge: 'Redeem',
    redeemRechargeHint: 'Enter a redeem code and add credits instantly',
    apiKeys: 'API Keys',
    todayRequests: 'Today Requests',
    todayCost: 'Today Cost',
    todayTokens: 'Today Tokens',
  ...
  admin: {
    ...
    adapterProviders: {
      ...
      description: 'Manage DB-backed long-tail adapter providers and inspect validity, enablement, and active routing slugs. Core providers remain native to sub2api.',
      observeOnly: 'Observe only',
      enforced: 'Enforced',
      enforcementEnabled: 'Route enforcement enabled',
      enforcementDisabled: 'Route enforcement disabled',
      createProvider: 'Create provider',
      editProvider: 'Edit provider',
      deleteTitle: 'Delete adapter provider',
      deleteConfirm: 'Delete "{name}"? Linked route policies may block deletion.',
      created: 'Adapter provider created',
      updated: 'Adapter provider updated',
      saveFailed: 'Failed to save adapter provider',
      deleteFailed: 'Failed to delete adapter provider',
      providerNotFound: 'Adapter provider not found',
      invalidJson: 'Invalid JSON',
      totalConfigured: 'Configured',
      activeConfigured: 'Active',
      disabledConfigured: 'Disabled',
      invalidConfigured: 'Invalid',
      activeSlugs: 'Active route slugs',
      activeSlugsHint: 'Only valid active long-tail providers are passed to CapabilityRouter.',
      noActiveSlugs: 'No active adapter slugs',
      enabled: 'Enabled',
      disabled: 'Disabled',
      invalid: 'Invalid',
      reasonEnabled: 'Included in adapter route candidates',
      reasonDisabled: 'Provider is disabled',
      ...
      operator: {
        ...
        streamFinalized: 'Stream finalized',
        websocketTraffic: 'WebSocket',
        costToday: 'Total cost',
        readyRoutes: 'Routable providers',
        noIssues: 'Healthy',
        needsAttention: 'Needs attention',
        focusRequests: 'Filter request audit: {metric}'
      },
      usage: {
        totalRequests: 'Adapter requests',
        successRate: 'Success rate',
        totalCost: 'Adapter cost',
      ...
      form: {
        ...
        credentialsKeepPlaceholder: 'Leave blank to keep existing credentials',
        existingCredentialKeys: 'Existing credential keys: {keys}',
        extra: 'Extra JSON',
        capabilitiesRequired: 'Enter at least one capability',
        objectJsonRequired: '{field} must be a JSON object'
      },
      routePolicies: {
        title: 'Route Policies',
        description: 'Configure explicit long-tail adapter route policies. Policies default to disabled, and core provider platforms cannot route to adapters.',
        createPolicy: 'Create policy',
        editPolicy: 'Edit policy',
        created: 'Route policy created',
        updated: 'Route policy updated',
        saveFailed: 'Failed to save route policy',
        deleteFailed: 'Failed to delete route policy',
        deleteTitle: 'Delete route policy',
        deleteConfirm: 'Delete "{name}"?',
        emptyTitle: 'No route policies',
        emptyDescription: 'No explicit route policies are configured. Gateway behavior remains observe-only.',
        columns: {
          policy: 'Policy',
          match: 'Match',
          target: 'Target'
        ...
        form: {
          ...
          matchCapability: 'Match capability',
          matchModel: 'Match model',
          matchGroupPlatform: 'Match group platform',
          target: 'Target',
      ...
      requests: {
        title: 'Adapter Request Audit',
        description: 'Inspect recent requests routed to long-tail adapters, including response status, latency, and billing reconciliation.',
        allProviders: 'All providers',
        allStatus: 'All status',
        success: 'Success',
        failed: 'Failed',
        searchRequest: 'Search request_id',
        loadFailed: 'Failed to load adapter requests',
        billingApplied: 'Billed',
        billingSkipped: 'Not billed',
        ...
        loadedTotalCount: '{count} / {total} loaded',
        loadMore: 'Load more',
        ...
        goToPage: 'Go',
        markers: {
          streamFinalized: 'Stream billed',
          websocketFinalized: 'WS billed',
          websocketTunnel: 'WS tunnel'
        },
        emptyTitle: 'No adapter requests',
        emptyDescription: 'No requests have matched a long-tail adapter yet.',
        columns: {
          request: 'Request',
          provider: 'Provider',
          status: 'Status',
