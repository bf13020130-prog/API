...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/adapters', label: t('nav.adapterOperations'), icon: ServerIcon, hideInSimpleMode: true },
    ...
    { path: '/admin/groups', label: t('nav.groups'), icon: FolderIcon, hideInSimpleMode: true },
    {
      ...
      children: [
        ...
        { path: '/admin/channels/adapters', label: t('nav.adapterProviders'), icon: ServerIcon },
      ],
    },
