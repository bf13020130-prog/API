...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/admin/adapters',
    name: 'AdminAdapterOperations',
    component: () => import('@/views/admin/AdapterProvidersView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Adapter Operations',
      titleKey: 'admin.adapterProviders.title',
      descriptionKey: 'admin.adapterProviders.description'
    }
  },
  {
    path: '/admin/users',
  ...
  {
    path: '/admin/channels/adapters',
    name: 'AdminAdapterProviders',
    component: () => import('@/views/admin/AdapterProvidersView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Adapter Providers',
      titleKey: 'admin.adapterProviders.title',
      descriptionKey: 'admin.adapterProviders.description'
    }
  },
