...
func ProvideAdapterClient(registry adapterclient.ProviderRegistry) adapterclient.Client {
	return adapterclient.NewHTTPClient(registry, nil)
}

func ProvideAdapterEnforcementService(
	cfg *config.Config,
	...
	if cfg != nil {
		enabled = cfg.Gateway.AdapterEnforcement.Enabled
		diagnosticSampling = AdapterDiagnosticSamplingConfig{
			Enabled:         cfg.Gateway.AdapterEnforcement.DiagnosticSampling.Enabled,
			SampleAll:       cfg.Gateway.AdapterEnforcement.DiagnosticSampling.SampleAll,
			Providers:       append([]string(nil), cfg.Gateway.AdapterEnforcement.DiagnosticSampling.Providers...),
			RequestIDs:      append([]string(nil), cfg.Gateway.AdapterEnforcement.DiagnosticSampling.RequestIDs...),
			MaxPayloadBytes: cfg.Gateway.AdapterEnforcement.DiagnosticSampling.MaxPayloadBytes,
			MaxStringBytes:  cfg.Gateway.AdapterEnforcement.DiagnosticSampling.MaxStringBytes,
			MaxEvents:       cfg.Gateway.AdapterEnforcement.DiagnosticSampling.MaxEvents,
		}
	}
	svc := NewAdapterEnforcementService(
		AdapterEnforcementConfig{
			Enabled:            enabled,
			DiagnosticSampling: diagnosticSampling,
		},
		routePolicySvc,
		adapterProviderSvc,
		adapterRequestSvc,
	...
	svc.SetAdapterUsageService(adapterUsageSvc)
	return svc
}
...
var ProviderSet = wire.NewSet(
	...
	NewUsageCache,
	NewTotpService,
	NewAdapterProviderService,
	NewRoutePolicyService,
	NewAdapterRequestService,
	NewAdapterUsageService,
	ProvideAdapterClient,
	ProvideAdapterEnforcementService,
	wire.Bind(new(adapterclient.ProviderRegistry), new(*AdapterProviderService)),
