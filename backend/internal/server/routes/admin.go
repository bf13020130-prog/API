...
func registerSystemRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	system := admin.Group("/system")
	{
		...
		system.GET("/adapter-providers", h.Admin.System.ListAdapterProviders)
		system.GET("/adapter-providers/diagnostics", h.Admin.System.GetAdapterProviderDiagnostics)
		system.GET("/adapter-providers/:id", h.Admin.System.GetAdapterProvider)
		system.POST("/adapter-providers", h.Admin.System.CreateAdapterProvider)
		system.PUT("/adapter-providers/:id", h.Admin.System.UpdateAdapterProvider)
		system.DELETE("/adapter-providers/:id", h.Admin.System.DeleteAdapterProvider)
		system.GET("/route-policies", h.Admin.System.ListRoutePolicies)
		system.GET("/route-policies/:id", h.Admin.System.GetRoutePolicy)
		system.POST("/route-policies", h.Admin.System.CreateRoutePolicy)
		system.PUT("/route-policies/:id", h.Admin.System.UpdateRoutePolicy)
		system.DELETE("/route-policies/:id", h.Admin.System.DeleteRoutePolicy)
		system.GET("/adapter-requests", h.Admin.System.ListAdapterRequests)
		system.GET("/adapter-requests/count", h.Admin.System.CountAdapterRequests)
		system.GET("/adapter-usages", h.Admin.System.ListAdapterUsages)
		system.GET("/adapter-usages/summary", h.Admin.System.GetAdapterUsageSummary)
