...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, apiKeyService, subscriptionService, opsService, settingService, adapterRegistry, adapterEnforcementSvc, cfg, redisClient)
}
