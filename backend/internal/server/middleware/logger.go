...
func Logger() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		capabilityDecision, hasCapabilityDecision := c.Request.Context().Value(ctxkey.CapabilityRouteDecision).(capabilityrouter.Decision)
		...
		if hasCapabilityDecision {
			fields = append(fields,
				zap.String("capability_route_target", string(capabilityDecision.Target)),
				zap.String("capability_route_platform", capabilityDecision.Platform),
				zap.String("capability_route_reason", capabilityDecision.Reason),
