...
func init() {
	...
	adapterproviderMixin := schema.AdapterProvider{}.Mixin()
	adapterproviderMixinHooks1 := adapterproviderMixin[1].Hooks()
	adapterprovider.Hooks[0] = adapterproviderMixinHooks1[0]
	adapterproviderMixinInters1 := adapterproviderMixin[1].Interceptors()
	adapterprovider.Interceptors[0] = adapterproviderMixinInters1[0]
	adapterproviderMixinFields0 := adapterproviderMixin[0].Fields()
	_ = adapterproviderMixinFields0
	adapterproviderFields := schema.AdapterProvider{}.Fields()
	_ = adapterproviderFields
	// adapterproviderDescCreatedAt is the schema descriptor for created_at field.
	adapterproviderDescCreatedAt := adapterproviderMixinFields0[0].Descriptor()
	// adapterprovider.DefaultCreatedAt holds the default value on creation for the created_at field.
	adapterprovider.DefaultCreatedAt = adapterproviderDescCreatedAt.Default.(func() time.Time)
	// adapterproviderDescUpdatedAt is the schema descriptor for updated_at field.
	adapterproviderDescUpdatedAt := adapterproviderMixinFields0[1].Descriptor()
	// adapterprovider.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	adapterprovider.DefaultUpdatedAt = adapterproviderDescUpdatedAt.Default.(func() time.Time)
	// adapterprovider.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	adapterprovider.UpdateDefaultUpdatedAt = adapterproviderDescUpdatedAt.UpdateDefault.(func() time.Time)
	// adapterproviderDescName is the schema descriptor for name field.
	adapterproviderDescName := adapterproviderFields[0].Descriptor()
	// adapterprovider.NameValidator is a validator for the "name" field. It is called by the builders before save.
	adapterprovider.NameValidator = func() func(string) error {
		validators := adapterproviderDescName.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterproviderDescSlug is the schema descriptor for slug field.
	adapterproviderDescSlug := adapterproviderFields[1].Descriptor()
	// adapterprovider.SlugValidator is a validator for the "slug" field. It is called by the builders before save.
	adapterprovider.SlugValidator = func() func(string) error {
		validators := adapterproviderDescSlug.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterproviderDescStatus is the schema descriptor for status field.
	adapterproviderDescStatus := adapterproviderFields[2].Descriptor()
	// adapterprovider.DefaultStatus holds the default value on creation for the status field.
	adapterprovider.DefaultStatus = adapterproviderDescStatus.Default.(string)
	// adapterprovider.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	adapterprovider.StatusValidator = adapterproviderDescStatus.Validators[0].(func(string) error)
	// adapterproviderDescAdapterType is the schema descriptor for adapter_type field.
	adapterproviderDescAdapterType := adapterproviderFields[3].Descriptor()
	// adapterprovider.DefaultAdapterType holds the default value on creation for the adapter_type field.
	adapterprovider.DefaultAdapterType = adapterproviderDescAdapterType.Default.(string)
	// adapterprovider.AdapterTypeValidator is a validator for the "adapter_type" field. It is called by the builders before save.
	adapterprovider.AdapterTypeValidator = adapterproviderDescAdapterType.Validators[0].(func(string) error)
	// adapterproviderDescBaseURL is the schema descriptor for base_url field.
	adapterproviderDescBaseURL := adapterproviderFields[4].Descriptor()
	// adapterprovider.BaseURLValidator is a validator for the "base_url" field. It is called by the builders before save.
	adapterprovider.BaseURLValidator = func() func(string) error {
		validators := adapterproviderDescBaseURL.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterproviderDescAuthMode is the schema descriptor for auth_mode field.
	adapterproviderDescAuthMode := adapterproviderFields[5].Descriptor()
	// adapterprovider.AuthModeValidator is a validator for the "auth_mode" field. It is called by the builders before save.
	adapterprovider.AuthModeValidator = adapterproviderDescAuthMode.Validators[0].(func(string) error)
	// adapterproviderDescPriority is the schema descriptor for priority field.
	adapterproviderDescPriority := adapterproviderFields[8].Descriptor()
	// adapterprovider.DefaultPriority holds the default value on creation for the priority field.
	adapterprovider.DefaultPriority = adapterproviderDescPriority.Default.(int)
	// adapterproviderDescTimeoutMs is the schema descriptor for timeout_ms field.
	adapterproviderDescTimeoutMs := adapterproviderFields[9].Descriptor()
	// adapterprovider.DefaultTimeoutMs holds the default value on creation for the timeout_ms field.
	adapterprovider.DefaultTimeoutMs = adapterproviderDescTimeoutMs.Default.(int)
	adapterrequestFields := schema.AdapterRequest{}.Fields()
	_ = adapterrequestFields
	// adapterrequestDescRequestID is the schema descriptor for request_id field.
	adapterrequestDescRequestID := adapterrequestFields[0].Descriptor()
	// adapterrequest.RequestIDValidator is a validator for the "request_id" field. It is called by the builders before save.
	adapterrequest.RequestIDValidator = func() func(string) error {
		validators := adapterrequestDescRequestID.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterrequestDescProvider is the schema descriptor for provider field.
	adapterrequestDescProvider := adapterrequestFields[5].Descriptor()
	// adapterrequest.ProviderValidator is a validator for the "provider" field. It is called by the builders before save.
	adapterrequest.ProviderValidator = func() func(string) error {
		validators := adapterrequestDescProvider.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterrequestDescCapability is the schema descriptor for capability field.
	adapterrequestDescCapability := adapterrequestFields[6].Descriptor()
	// adapterrequest.CapabilityValidator is a validator for the "capability" field. It is called by the builders before save.
	adapterrequest.CapabilityValidator = func() func(string) error {
		validators := adapterrequestDescCapability.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterrequestDescRouteTarget is the schema descriptor for route_target field.
	adapterrequestDescRouteTarget := adapterrequestFields[7].Descriptor()
	// adapterrequest.DefaultRouteTarget holds the default value on creation for the route_target field.
	adapterrequest.DefaultRouteTarget = adapterrequestDescRouteTarget.Default.(string)
	// adapterrequest.RouteTargetValidator is a validator for the "route_target" field. It is called by the builders before save.
	adapterrequest.RouteTargetValidator = adapterrequestDescRouteTarget.Validators[0].(func(string) error)
	// adapterrequestDescMethod is the schema descriptor for method field.
	adapterrequestDescMethod := adapterrequestFields[8].Descriptor()
	// adapterrequest.MethodValidator is a validator for the "method" field. It is called by the builders before save.
	adapterrequest.MethodValidator = func() func(string) error {
		validators := adapterrequestDescMethod.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterrequestDescPath is the schema descriptor for path field.
	adapterrequestDescPath := adapterrequestFields[9].Descriptor()
	// adapterrequest.PathValidator is a validator for the "path" field. It is called by the builders before save.
	adapterrequest.PathValidator = func() func(string) error {
		validators := adapterrequestDescPath.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterrequestDescModel is the schema descriptor for model field.
	adapterrequestDescModel := adapterrequestFields[10].Descriptor()
	// adapterrequest.ModelValidator is a validator for the "model" field. It is called by the builders before save.
	adapterrequest.ModelValidator = adapterrequestDescModel.Validators[0].(func(string) error)
	// adapterrequestDescCreatedAt is the schema descriptor for created_at field.
	adapterrequestDescCreatedAt := adapterrequestFields[15].Descriptor()
	// adapterrequest.DefaultCreatedAt holds the default value on creation for the created_at field.
	adapterrequest.DefaultCreatedAt = adapterrequestDescCreatedAt.Default.(func() time.Time)
	adapterusagerecordFields := schema.AdapterUsageRecord{}.Fields()
	_ = adapterusagerecordFields
	// adapterusagerecordDescRequestID is the schema descriptor for request_id field.
	adapterusagerecordDescRequestID := adapterusagerecordFields[0].Descriptor()
	// adapterusagerecord.RequestIDValidator is a validator for the "request_id" field. It is called by the builders before save.
	adapterusagerecord.RequestIDValidator = func() func(string) error {
		validators := adapterusagerecordDescRequestID.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterusagerecordDescProvider is the schema descriptor for provider field.
	adapterusagerecordDescProvider := adapterusagerecordFields[6].Descriptor()
	// adapterusagerecord.ProviderValidator is a validator for the "provider" field. It is called by the builders before save.
	adapterusagerecord.ProviderValidator = func() func(string) error {
		validators := adapterusagerecordDescProvider.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterusagerecordDescCapability is the schema descriptor for capability field.
	adapterusagerecordDescCapability := adapterusagerecordFields[7].Descriptor()
	// adapterusagerecord.CapabilityValidator is a validator for the "capability" field. It is called by the builders before save.
	adapterusagerecord.CapabilityValidator = func() func(string) error {
		validators := adapterusagerecordDescCapability.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterusagerecordDescModel is the schema descriptor for model field.
	adapterusagerecordDescModel := adapterusagerecordFields[8].Descriptor()
	// adapterusagerecord.ModelValidator is a validator for the "model" field. It is called by the builders before save.
	adapterusagerecord.ModelValidator = adapterusagerecordDescModel.Validators[0].(func(string) error)
	// adapterusagerecordDescMethod is the schema descriptor for method field.
	adapterusagerecordDescMethod := adapterusagerecordFields[9].Descriptor()
	// adapterusagerecord.MethodValidator is a validator for the "method" field. It is called by the builders before save.
	adapterusagerecord.MethodValidator = adapterusagerecordDescMethod.Validators[0].(func(string) error)
	// adapterusagerecordDescPath is the schema descriptor for path field.
	adapterusagerecordDescPath := adapterusagerecordFields[10].Descriptor()
	// adapterusagerecord.PathValidator is a validator for the "path" field. It is called by the builders before save.
	adapterusagerecord.PathValidator = adapterusagerecordDescPath.Validators[0].(func(string) error)
	// adapterusagerecordDescStatus is the schema descriptor for status field.
	adapterusagerecordDescStatus := adapterusagerecordFields[11].Descriptor()
	// adapterusagerecord.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	adapterusagerecord.StatusValidator = func() func(string) error {
		validators := adapterusagerecordDescStatus.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// adapterusagerecordDescInputUnits is the schema descriptor for input_units field.
	adapterusagerecordDescInputUnits := adapterusagerecordFields[15].Descriptor()
	// adapterusagerecord.DefaultInputUnits holds the default value on creation for the input_units field.
	adapterusagerecord.DefaultInputUnits = adapterusagerecordDescInputUnits.Default.(int)
	// adapterusagerecordDescOutputUnits is the schema descriptor for output_units field.
	adapterusagerecordDescOutputUnits := adapterusagerecordFields[16].Descriptor()
	// adapterusagerecord.DefaultOutputUnits holds the default value on creation for the output_units field.
	adapterusagerecord.DefaultOutputUnits = adapterusagerecordDescOutputUnits.Default.(int)
	// adapterusagerecordDescBillableUnits is the schema descriptor for billable_units field.
	adapterusagerecordDescBillableUnits := adapterusagerecordFields[17].Descriptor()
	// adapterusagerecord.DefaultBillableUnits holds the default value on creation for the billable_units field.
	adapterusagerecord.DefaultBillableUnits = adapterusagerecordDescBillableUnits.Default.(int)
	// adapterusagerecordDescCostUsd is the schema descriptor for cost_usd field.
	adapterusagerecordDescCostUsd := adapterusagerecordFields[18].Descriptor()
	// adapterusagerecord.DefaultCostUsd holds the default value on creation for the cost_usd field.
	adapterusagerecord.DefaultCostUsd = adapterusagerecordDescCostUsd.Default.(float64)
	// adapterusagerecordDescBillableUnit is the schema descriptor for billable_unit field.
	adapterusagerecordDescBillableUnit := adapterusagerecordFields[19].Descriptor()
	// adapterusagerecord.DefaultBillableUnit holds the default value on creation for the billable_unit field.
	adapterusagerecord.DefaultBillableUnit = adapterusagerecordDescBillableUnit.Default.(int)
	// adapterusagerecordDescBillingApplied is the schema descriptor for billing_applied field.
	adapterusagerecordDescBillingApplied := adapterusagerecordFields[20].Descriptor()
	// adapterusagerecord.DefaultBillingApplied holds the default value on creation for the billing_applied field.
	adapterusagerecord.DefaultBillingApplied = adapterusagerecordDescBillingApplied.Default.(bool)
	// adapterusagerecordDescBillingFingerprint is the schema descriptor for billing_fingerprint field.
	adapterusagerecordDescBillingFingerprint := adapterusagerecordFields[21].Descriptor()
	// adapterusagerecord.BillingFingerprintValidator is a validator for the "billing_fingerprint" field. It is called by the builders before save.
	adapterusagerecord.BillingFingerprintValidator = adapterusagerecordDescBillingFingerprint.Validators[0].(func(string) error)
	// adapterusagerecordDescCreatedAt is the schema descriptor for created_at field.
	adapterusagerecordDescCreatedAt := adapterusagerecordFields[23].Descriptor()
	// adapterusagerecord.DefaultCreatedAt holds the default value on creation for the created_at field.
	adapterusagerecord.DefaultCreatedAt = adapterusagerecordDescCreatedAt.Default.(func() time.Time)
	...
	routepolicyMixinHooks1 := routepolicyMixin[1].Hooks()
	routepolicy.Hooks[0] = routepolicyMixinHooks1[0]
	routepolicyMixinInters1 := routepolicyMixin[1].Interceptors()
	routepolicy.Interceptors[0] = routepolicyMixinInters1[0]
	routepolicyMixinFields0 := routepolicyMixin[0].Fields()
	_ = routepolicyMixinFields0
	routepolicyFields := schema.RoutePolicy{}.Fields()
	_ = routepolicyFields
	// routepolicyDescCreatedAt is the schema descriptor for created_at field.
	routepolicyDescCreatedAt := routepolicyMixinFields0[0].Descriptor()
	// routepolicy.DefaultCreatedAt holds the default value on creation for the created_at field.
	routepolicy.DefaultCreatedAt = routepolicyDescCreatedAt.Default.(func() time.Time)
	// routepolicyDescUpdatedAt is the schema descriptor for updated_at field.
	routepolicyDescUpdatedAt := routepolicyMixinFields0[1].Descriptor()
	// routepolicy.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	routepolicy.DefaultUpdatedAt = routepolicyDescUpdatedAt.Default.(func() time.Time)
	// routepolicy.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	routepolicy.UpdateDefaultUpdatedAt = routepolicyDescUpdatedAt.UpdateDefault.(func() time.Time)
	// routepolicyDescName is the schema descriptor for name field.
	routepolicyDescName := routepolicyFields[0].Descriptor()
	// routepolicy.NameValidator is a validator for the "name" field. It is called by the builders before save.
	routepolicy.NameValidator = func() func(string) error {
		validators := routepolicyDescName.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// routepolicyDescStatus is the schema descriptor for status field.
	routepolicyDescStatus := routepolicyFields[1].Descriptor()
	// routepolicy.DefaultStatus holds the default value on creation for the status field.
	routepolicy.DefaultStatus = routepolicyDescStatus.Default.(string)
	// routepolicy.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	routepolicy.StatusValidator = routepolicyDescStatus.Validators[0].(func(string) error)
	// routepolicyDescMatchMethod is the schema descriptor for match_method field.
	routepolicyDescMatchMethod := routepolicyFields[2].Descriptor()
	// routepolicy.MatchMethodValidator is a validator for the "match_method" field. It is called by the builders before save.
	routepolicy.MatchMethodValidator = routepolicyDescMatchMethod.Validators[0].(func(string) error)
	// routepolicyDescMatchPath is the schema descriptor for match_path field.
	routepolicyDescMatchPath := routepolicyFields[3].Descriptor()
	// routepolicy.MatchPathValidator is a validator for the "match_path" field. It is called by the builders before save.
	routepolicy.MatchPathValidator = routepolicyDescMatchPath.Validators[0].(func(string) error)
	// routepolicyDescMatchModel is the schema descriptor for match_model field.
	routepolicyDescMatchModel := routepolicyFields[4].Descriptor()
	// routepolicy.MatchModelValidator is a validator for the "match_model" field. It is called by the builders before save.
	routepolicy.MatchModelValidator = routepolicyDescMatchModel.Validators[0].(func(string) error)
	// routepolicyDescMatchCapability is the schema descriptor for match_capability field.
	routepolicyDescMatchCapability := routepolicyFields[5].Descriptor()
	// routepolicy.MatchCapabilityValidator is a validator for the "match_capability" field. It is called by the builders before save.
	routepolicy.MatchCapabilityValidator = routepolicyDescMatchCapability.Validators[0].(func(string) error)
	// routepolicyDescMatchGroupPlatform is the schema descriptor for match_group_platform field.
	routepolicyDescMatchGroupPlatform := routepolicyFields[6].Descriptor()
	// routepolicy.MatchGroupPlatformValidator is a validator for the "match_group_platform" field. It is called by the builders before save.
	routepolicy.MatchGroupPlatformValidator = routepolicyDescMatchGroupPlatform.Validators[0].(func(string) error)
	// routepolicyDescTarget is the schema descriptor for target field.
	routepolicyDescTarget := routepolicyFields[7].Descriptor()
	// routepolicy.TargetValidator is a validator for the "target" field. It is called by the builders before save.
	routepolicy.TargetValidator = func() func(string) error {
		validators := routepolicyDescTarget.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// routepolicyDescPlatform is the schema descriptor for platform field.
	routepolicyDescPlatform := routepolicyFields[8].Descriptor()
	// routepolicy.PlatformValidator is a validator for the "platform" field. It is called by the builders before save.
	routepolicy.PlatformValidator = routepolicyDescPlatform.Validators[0].(func(string) error)
	// routepolicyDescPriority is the schema descriptor for priority field.
	routepolicyDescPriority := routepolicyFields[10].Descriptor()
	// routepolicy.DefaultPriority holds the default value on creation for the priority field.
	routepolicy.DefaultPriority = routepolicyDescPriority.Default.(int)
