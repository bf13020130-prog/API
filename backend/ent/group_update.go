...
func (_u *GroupUpdate) AddAdapterRequestIDs(ids ...int64) *GroupUpdate {
	_u.mutation.AddAdapterRequestIDs(ids...)
	return _u
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_u *GroupUpdate) AddAdapterRequests(v ...*AdapterRequest) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) AddAdapterUsageRecordIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) ClearAdapterRequests() *GroupUpdate {
...
func (_u *GroupUpdate) RemoveAdapterRequestIDs(ids ...int64) *GroupUpdate {
	_u.mutation.RemoveAdapterRequestIDs(ids...)
	return _u
}

// RemoveAdapterRequests removes "adapter_requests" edges to AdapterRequest entities.
func (_u *GroupUpdate) RemoveAdapterRequests(v ...*AdapterRequest) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) ClearAdapterUsageRecords() *GroupUpdate {
...
func (_u *GroupUpdate) RemoveAdapterUsageRecordIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) RemoveAdapterUsageRecords(v ...*AdapterUsageRecord) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AdapterRequestsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.AdapterRequestsTable,
			Columns: []string{group.AdapterRequestsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.AdapterUsageRecordsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.AdapterUsageRecordsTable,
			Columns: []string{group.AdapterUsageRecordsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddAdapterRequestIDs adds the "adapter_requests" edge to the AdapterRequest entity by IDs.
func (_u *GroupUpdateOne) AddAdapterRequestIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.AddAdapterRequestIDs(ids...)
	return _u
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_u *GroupUpdateOne) AddAdapterRequests(v ...*AdapterRequest) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddAdapterUsageRecordIDs adds the "adapter_usage_records" edge to the AdapterUsageRecord entity by IDs.
func (_u *GroupUpdateOne) AddAdapterUsageRecordIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.AddAdapterUsageRecordIDs(ids...)
	return _u
}

// AddAdapterUsageRecords adds the "adapter_usage_records" edges to the AdapterUsageRecord entity.
func (_u *GroupUpdateOne) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAdapterRequests clears all "adapter_requests" edges to the AdapterRequest entity.
func (_u *GroupUpdateOne) ClearAdapterRequests() *GroupUpdateOne {
	_u.mutation.ClearAdapterRequests()
	return _u
}

// RemoveAdapterRequestIDs removes the "adapter_requests" edge to AdapterRequest entities by IDs.
func (_u *GroupUpdateOne) RemoveAdapterRequestIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.RemoveAdapterRequestIDs(ids...)
	return _u
}

// RemoveAdapterRequests removes "adapter_requests" edges to AdapterRequest entities.
func (_u *GroupUpdateOne) RemoveAdapterRequests(v ...*AdapterRequest) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAdapterUsageRecords clears all "adapter_usage_records" edges to the AdapterUsageRecord entity.
func (_u *GroupUpdateOne) ClearAdapterUsageRecords() *GroupUpdateOne {
	_u.mutation.ClearAdapterUsageRecords()
	return _u
}

// RemoveAdapterUsageRecordIDs removes the "adapter_usage_records" edge to AdapterUsageRecord entities by IDs.
func (_u *GroupUpdateOne) RemoveAdapterUsageRecordIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.RemoveAdapterUsageRecordIDs(ids...)
	return _u
}

// RemoveAdapterUsageRecords removes "adapter_usage_records" edges to AdapterUsageRecord entities.
func (_u *GroupUpdateOne) RemoveAdapterUsageRecords(v ...*AdapterUsageRecord) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
