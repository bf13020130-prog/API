...
func HasAdapterRequests() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAdapterRequestsWith(preds ...predicate.AdapterRequest) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasAdapterUsageRecords() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAdapterUsageRecordsWith(preds ...predicate.AdapterUsageRecord) predicate.User {
	return predicate.User(func(s *sql.Selector) {
