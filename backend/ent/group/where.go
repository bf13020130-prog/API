...
func HasAdapterRequests() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAdapterRequestsWith(preds ...predicate.AdapterRequest) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func HasAdapterUsageRecords() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAdapterUsageRecordsWith(preds ...predicate.AdapterUsageRecord) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
