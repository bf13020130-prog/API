...
// was not loaded in eager-loading.
func (e APIKeyEdges) AdapterRequestsOrErr() ([]*AdapterRequest, error) {
	if e.loadedTypes[3] {
...
// was not loaded in eager-loading.
func (e APIKeyEdges) AdapterUsageRecordsOrErr() ([]*AdapterUsageRecord, error) {
	if e.loadedTypes[4] {
...
// QueryAdapterRequests queries the "adapter_requests" edge of the APIKey entity.
func (_m *APIKey) QueryAdapterRequests() *AdapterRequestQuery {
	return NewAPIKeyClient(_m.config).QueryAdapterRequests(_m)
}

// QueryAdapterUsageRecords queries the "adapter_usage_records" edge of the APIKey entity.
func (_m *APIKey) QueryAdapterUsageRecords() *AdapterUsageRecordQuery {
	return NewAPIKeyClient(_m.config).QueryAdapterUsageRecords(_m)
}
