...
func (_u *APIKeyUpdate) AddAdapterRequestIDs(ids ...int64) *APIKeyUpdate {
	_u.mutation.AddAdapterRequestIDs(ids...)
	return _u
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_u *APIKeyUpdate) AddAdapterRequests(v ...*AdapterRequest) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *APIKeyUpdate) AddAdapterUsageRecordIDs(ids ...int64) *APIKeyUpdate {
...
func (_u *APIKeyUpdate) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *APIKeyUpdate) ClearAdapterRequests() *APIKeyUpdate {
...
func (_u *APIKeyUpdate) RemoveAdapterRequestIDs(ids ...int64) *APIKeyUpdate {
	_u.mutation.RemoveAdapterRequestIDs(ids...)
	return _u
}

// RemoveAdapterRequests removes "adapter_requests" edges to AdapterRequest entities.
func (_u *APIKeyUpdate) RemoveAdapterRequests(v ...*AdapterRequest) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *APIKeyUpdate) ClearAdapterUsageRecords() *APIKeyUpdate {
...
func (_u *APIKeyUpdate) RemoveAdapterUsageRecordIDs(ids ...int64) *APIKeyUpdate {
...
func (_u *APIKeyUpdate) RemoveAdapterUsageRecords(v ...*AdapterUsageRecord) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AdapterRequestsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   apikey.AdapterRequestsTable,
			Columns: []string{apikey.AdapterRequestsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.AdapterUsageRecordsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   apikey.AdapterUsageRecordsTable,
			Columns: []string{apikey.AdapterUsageRecordsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddAdapterRequestIDs adds the "adapter_requests" edge to the AdapterRequest entity by IDs.
func (_u *APIKeyUpdateOne) AddAdapterRequestIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.AddAdapterRequestIDs(ids...)
	return _u
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_u *APIKeyUpdateOne) AddAdapterRequests(v ...*AdapterRequest) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddAdapterUsageRecordIDs adds the "adapter_usage_records" edge to the AdapterUsageRecord entity by IDs.
func (_u *APIKeyUpdateOne) AddAdapterUsageRecordIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.AddAdapterUsageRecordIDs(ids...)
	return _u
}

// AddAdapterUsageRecords adds the "adapter_usage_records" edges to the AdapterUsageRecord entity.
func (_u *APIKeyUpdateOne) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAdapterRequests clears all "adapter_requests" edges to the AdapterRequest entity.
func (_u *APIKeyUpdateOne) ClearAdapterRequests() *APIKeyUpdateOne {
	_u.mutation.ClearAdapterRequests()
	return _u
}

// RemoveAdapterRequestIDs removes the "adapter_requests" edge to AdapterRequest entities by IDs.
func (_u *APIKeyUpdateOne) RemoveAdapterRequestIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.RemoveAdapterRequestIDs(ids...)
	return _u
}

// RemoveAdapterRequests removes "adapter_requests" edges to AdapterRequest entities.
func (_u *APIKeyUpdateOne) RemoveAdapterRequests(v ...*AdapterRequest) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAdapterUsageRecords clears all "adapter_usage_records" edges to the AdapterUsageRecord entity.
func (_u *APIKeyUpdateOne) ClearAdapterUsageRecords() *APIKeyUpdateOne {
	_u.mutation.ClearAdapterUsageRecords()
	return _u
}

// RemoveAdapterUsageRecordIDs removes the "adapter_usage_records" edge to AdapterUsageRecord entities by IDs.
func (_u *APIKeyUpdateOne) RemoveAdapterUsageRecordIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.RemoveAdapterUsageRecordIDs(ids...)
	return _u
}

// RemoveAdapterUsageRecords removes "adapter_usage_records" edges to AdapterUsageRecord entities.
func (_u *APIKeyUpdateOne) RemoveAdapterUsageRecords(v ...*AdapterUsageRecord) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
