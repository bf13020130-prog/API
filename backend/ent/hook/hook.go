...
// The AdapterProviderFunc type is an adapter to allow the use of ordinary
// function as AdapterProvider mutator.
type AdapterProviderFunc func(context.Context, *ent.AdapterProviderMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AdapterProviderFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AdapterProviderMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AdapterProviderMutation", m)
}

// The AdapterRequestFunc type is an adapter to allow the use of ordinary
// function as AdapterRequest mutator.
type AdapterRequestFunc func(context.Context, *ent.AdapterRequestMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AdapterRequestFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AdapterRequestMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AdapterRequestMutation", m)
}

// The AdapterUsageRecordFunc type is an adapter to allow the use of ordinary
// function as AdapterUsageRecord mutator.
type AdapterUsageRecordFunc func(context.Context, *ent.AdapterUsageRecordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AdapterUsageRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AdapterUsageRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AdapterUsageRecordMutation", m)
}
