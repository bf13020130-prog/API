...
// The AdapterProviderFunc type is an adapter to allow the use of ordinary function as a Querier.
type AdapterProviderFunc func(context.Context, *ent.AdapterProviderQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AdapterProviderFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AdapterProviderQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AdapterProviderQuery", q)
}

// The TraverseAdapterProvider type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAdapterProvider func(context.Context, *ent.AdapterProviderQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAdapterProvider) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAdapterProvider) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AdapterProviderQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AdapterProviderQuery", q)
}

// The AdapterRequestFunc type is an adapter to allow the use of ordinary function as a Querier.
type AdapterRequestFunc func(context.Context, *ent.AdapterRequestQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AdapterRequestFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AdapterRequestQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AdapterRequestQuery", q)
}

// The TraverseAdapterRequest type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAdapterRequest func(context.Context, *ent.AdapterRequestQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAdapterRequest) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAdapterRequest) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AdapterRequestQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AdapterRequestQuery", q)
}

// The AdapterUsageRecordFunc type is an adapter to allow the use of ordinary function as a Querier.
type AdapterUsageRecordFunc func(context.Context, *ent.AdapterUsageRecordQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AdapterUsageRecordFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AdapterUsageRecordQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AdapterUsageRecordQuery", q)
}

// The TraverseAdapterUsageRecord type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAdapterUsageRecord func(context.Context, *ent.AdapterUsageRecordQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAdapterUsageRecord) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAdapterUsageRecord) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AdapterUsageRecordQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AdapterUsageRecordQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.AdapterProviderQuery:
		return &query[*ent.AdapterProviderQuery, predicate.AdapterProvider, adapterprovider.OrderOption]{typ: ent.TypeAdapterProvider, tq: q}, nil
	case *ent.AdapterRequestQuery:
		return &query[*ent.AdapterRequestQuery, predicate.AdapterRequest, adapterrequest.OrderOption]{typ: ent.TypeAdapterRequest, tq: q}, nil
	case *ent.AdapterUsageRecordQuery:
		return &query[*ent.AdapterUsageRecordQuery, predicate.AdapterUsageRecord, adapterusagerecord.OrderOption]{typ: ent.TypeAdapterUsageRecord, tq: q}, nil
