...
var (
	...
	// AdapterProvidersColumns holds the columns for the "adapter_providers" table.
	AdapterProvidersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		...
		{Name: "adapter_type", Type: field.TypeString, Size: 32, Default: "new-api"},
		{Name: "base_url", Type: field.TypeString, Size: 512},
		{Name: "auth_mode", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "credentials", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "capabilities", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "priority", Type: field.TypeInt, Default: 50},
	...
	// AdapterProvidersTable holds the schema information for the "adapter_providers" table.
	AdapterProvidersTable = &schema.Table{
		Name:       "adapter_providers",
		Columns:    AdapterProvidersColumns,
		PrimaryKey: []*schema.Column{AdapterProvidersColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "adapterprovider_slug",
				Unique:  true,
				Columns: []*schema.Column{AdapterProvidersColumns[5]},
			},
			{
				Name:    "adapterprovider_status",
				Unique:  false,
				Columns: []*schema.Column{AdapterProvidersColumns[6]},
			},
			{
				Name:    "adapterprovider_adapter_type",
				Unique:  false,
				Columns: []*schema.Column{AdapterProvidersColumns[7]},
			},
			{
				Name:    "adapterprovider_deleted_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterProvidersColumns[3]},
			},
			{
				Name:    "adapterprovider_priority",
				Unique:  false,
				Columns: []*schema.Column{AdapterProvidersColumns[12]},
			},
		},
	}
	// AdapterRequestsColumns holds the columns for the "adapter_requests" table.
	AdapterRequestsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "request_id", Type: field.TypeString, Size: 64},
		{Name: "provider", Type: field.TypeString, Size: 64},
		{Name: "capability", Type: field.TypeString, Size: 64},
		{Name: "route_target", Type: field.TypeString, Size: 32, Default: "new_api_adapter"},
		...
		{Name: "adapter_provider_id", Type: field.TypeInt64},
		{Name: "group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "user_id", Type: field.TypeInt64},
	}
	// AdapterRequestsTable holds the schema information for the "adapter_requests" table.
	AdapterRequestsTable = &schema.Table{
		Name:       "adapter_requests",
		Columns:    AdapterRequestsColumns,
		PrimaryKey: []*schema.Column{AdapterRequestsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "adapter_requests_api_keys_adapter_requests",
				Columns:    []*schema.Column{AdapterRequestsColumns[13]},
				RefColumns: []*schema.Column{APIKeysColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "adapter_requests_adapter_providers_adapter_requests",
				Columns:    []*schema.Column{AdapterRequestsColumns[14]},
				RefColumns: []*schema.Column{AdapterProvidersColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "adapter_requests_groups_adapter_requests",
				Columns:    []*schema.Column{AdapterRequestsColumns[15]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "adapter_requests_users_adapter_requests",
				Columns:    []*schema.Column{AdapterRequestsColumns[16]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "adapterrequest_request_id",
				Unique:  false,
				Columns: []*schema.Column{AdapterRequestsColumns[1]},
			},
			{
				Name:    "adapterrequest_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterRequestsColumns[16], AdapterRequestsColumns[12]},
			},
			{
				Name:    "adapterrequest_api_key_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterRequestsColumns[13], AdapterRequestsColumns[12]},
			},
			{
				Name:    "adapterrequest_group_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterRequestsColumns[15], AdapterRequestsColumns[12]},
			},
			{
				Name:    "adapterrequest_adapter_provider_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterRequestsColumns[14], AdapterRequestsColumns[12]},
			},
			{
				Name:    "adapterrequest_provider_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterRequestsColumns[2], AdapterRequestsColumns[12]},
			},
			{
				Name:    "adapterrequest_route_target",
				Unique:  false,
				Columns: []*schema.Column{AdapterRequestsColumns[4]},
			},
		},
	}
	// AdapterUsageRecordsColumns holds the columns for the "adapter_usage_records" table.
	AdapterUsageRecordsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "request_id", Type: field.TypeString, Size: 64},
		{Name: "provider", Type: field.TypeString, Size: 64},
		{Name: "capability", Type: field.TypeString, Size: 64},
		...
		{Name: "duration_ms", Type: field.TypeInt, Nullable: true},
		{Name: "error_message", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "input_units", Type: field.TypeInt, Default: 0},
		{Name: "output_units", Type: field.TypeInt, Default: 0},
		{Name: "billable_units", Type: field.TypeInt, Default: 0},
		{Name: "cost_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "billable_unit", Type: field.TypeInt, Default: 0},
		{Name: "billing_applied", Type: field.TypeBool, Default: false},
		{Name: "billing_fingerprint", Type: field.TypeString, Nullable: true, Size: 160},
		{Name: "metadata", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "api_key_id", Type: field.TypeInt64},
		{Name: "adapter_provider_id", Type: field.TypeInt64},
		{Name: "group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "route_policy_id", Type: field.TypeInt64, Nullable: true},
		{Name: "user_id", Type: field.TypeInt64},
	}
	// AdapterUsageRecordsTable holds the schema information for the "adapter_usage_records" table.
	AdapterUsageRecordsTable = &schema.Table{
		Name:       "adapter_usage_records",
		Columns:    AdapterUsageRecordsColumns,
		PrimaryKey: []*schema.Column{AdapterUsageRecordsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "adapter_usage_records_api_keys_adapter_usage_records",
				Columns:    []*schema.Column{AdapterUsageRecordsColumns[20]},
				RefColumns: []*schema.Column{APIKeysColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "adapter_usage_records_adapter_providers_adapter_usage_records",
				Columns:    []*schema.Column{AdapterUsageRecordsColumns[21]},
				RefColumns: []*schema.Column{AdapterProvidersColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "adapter_usage_records_groups_adapter_usage_records",
				Columns:    []*schema.Column{AdapterUsageRecordsColumns[22]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "adapter_usage_records_route_policies_adapter_usage_records",
				Columns:    []*schema.Column{AdapterUsageRecordsColumns[23]},
				RefColumns: []*schema.Column{RoutePoliciesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "adapter_usage_records_users_adapter_usage_records",
				Columns:    []*schema.Column{AdapterUsageRecordsColumns[24]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "adapterusagerecord_request_id",
				Unique:  false,
				Columns: []*schema.Column{AdapterUsageRecordsColumns[1]},
			},
			{
				Name:    "adapterusagerecord_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterUsageRecordsColumns[24], AdapterUsageRecordsColumns[19]},
			},
			{
				Name:    "adapterusagerecord_api_key_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterUsageRecordsColumns[20], AdapterUsageRecordsColumns[19]},
			},
			{
				Name:    "adapterusagerecord_group_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterUsageRecordsColumns[22], AdapterUsageRecordsColumns[19]},
			},
			{
				Name:    "adapterusagerecord_adapter_provider_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterUsageRecordsColumns[21], AdapterUsageRecordsColumns[19]},
			},
			{
				Name:    "adapterusagerecord_provider_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterUsageRecordsColumns[2], AdapterUsageRecordsColumns[19]},
			},
			{
				Name:    "adapterusagerecord_status_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterUsageRecordsColumns[7], AdapterUsageRecordsColumns[19]},
			},
			{
				Name:    "adapterusagerecord_model_created_at",
				Unique:  false,
				Columns: []*schema.Column{AdapterUsageRecordsColumns[4], AdapterUsageRecordsColumns[19]},
			},
		},
	}
	...
	RoutePoliciesColumns = []*schema.Column{
		...
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "disabled"},
		{Name: "match_method", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "match_path", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "match_model", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "match_capability", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "match_group_platform", Type: field.TypeString, Nullable: true, Size: 50},
		{Name: "target", Type: field.TypeString, Size: 32},
		...
		{Name: "description", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "adapter_provider_id", Type: field.TypeInt64, Nullable: true},
	}
	...
	RoutePoliciesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "route_policies_adapter_providers_route_policies",
				Columns:    []*schema.Column{RoutePoliciesColumns[16]},
				RefColumns: []*schema.Column{AdapterProvidersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "routepolicy_status",
				Unique:  false,
				Columns: []*schema.Column{RoutePoliciesColumns[5]},
			},
			{
				Name:    "routepolicy_target",
				Unique:  false,
				Columns: []*schema.Column{RoutePoliciesColumns[11]},
			},
			{
				Name:    "routepolicy_priority",
				Unique:  false,
				Columns: []*schema.Column{RoutePoliciesColumns[13]},
			},
			{
				Name:    "routepolicy_adapter_provider_id",
				Unique:  false,
				Columns: []*schema.Column{RoutePoliciesColumns[16]},
			},
			{
				Name:    "routepolicy_match_group_platform_status",
				Unique:  false,
				Columns: []*schema.Column{RoutePoliciesColumns[10], RoutePoliciesColumns[5]},
			},
			{
				Name:    "routepolicy_match_path_match_method",
				Unique:  false,
				Columns: []*schema.Column{RoutePoliciesColumns[7], RoutePoliciesColumns[6]},
			},
			{
				Name:    "routepolicy_deleted_at",
				Unique:  false,
	...
	Tables = []*schema.Table{
		...
		AdapterRequestsTable,
		AdapterUsageRecordsTable,
		AnnouncementsTable,
...
func init() {
	...
	AdapterProvidersTable.Annotation = &entsql.Annotation{
		Table: "adapter_providers",
	}
	AdapterRequestsTable.ForeignKeys[0].RefTable = APIKeysTable
	AdapterRequestsTable.ForeignKeys[1].RefTable = AdapterProvidersTable
	AdapterRequestsTable.ForeignKeys[2].RefTable = GroupsTable
	AdapterRequestsTable.ForeignKeys[3].RefTable = UsersTable
	AdapterRequestsTable.Annotation = &entsql.Annotation{
		Table: "adapter_requests",
	}
	AdapterUsageRecordsTable.ForeignKeys[0].RefTable = APIKeysTable
	AdapterUsageRecordsTable.ForeignKeys[1].RefTable = AdapterProvidersTable
	AdapterUsageRecordsTable.ForeignKeys[2].RefTable = GroupsTable
	AdapterUsageRecordsTable.ForeignKeys[3].RefTable = RoutePoliciesTable
	AdapterUsageRecordsTable.ForeignKeys[4].RefTable = UsersTable
	AdapterUsageRecordsTable.Annotation = &entsql.Annotation{
	...
	RoutePoliciesTable.ForeignKeys[0].RefTable = AdapterProvidersTable
