...
func HasAdapterRequests() predicate.APIKey {
	return predicate.APIKey(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAdapterRequestsWith(preds ...predicate.AdapterRequest) predicate.APIKey {
	return predicate.APIKey(func(s *sql.Selector) {
...
func HasAdapterUsageRecords() predicate.APIKey {
	return predicate.APIKey(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAdapterUsageRecordsWith(preds ...predicate.AdapterUsageRecord) predicate.APIKey {
	return predicate.APIKey(func(s *sql.Selector) {
