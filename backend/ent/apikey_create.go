...
func (_c *APIKeyCreate) AddAdapterRequestIDs(ids ...int64) *APIKeyCreate {
	_c.mutation.AddAdapterRequestIDs(ids...)
	return _c
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_c *APIKeyCreate) AddAdapterRequests(v ...*AdapterRequest) *APIKeyCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *APIKeyCreate) AddAdapterUsageRecordIDs(ids ...int64) *APIKeyCreate {
...
func (_c *APIKeyCreate) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *APIKeyCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
