...
func (_u *UserUpdate) AddAdapterRequestIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddAdapterRequestIDs(ids...)
	return _u
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_u *UserUpdate) AddAdapterRequests(v ...*AdapterRequest) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) AddAdapterUsageRecordIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) ClearAdapterRequests() *UserUpdate {
...
func (_u *UserUpdate) RemoveAdapterRequestIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveAdapterRequestIDs(ids...)
	return _u
}

// RemoveAdapterRequests removes "adapter_requests" edges to AdapterRequest entities.
func (_u *UserUpdate) RemoveAdapterRequests(v ...*AdapterRequest) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) ClearAdapterUsageRecords() *UserUpdate {
...
func (_u *UserUpdate) RemoveAdapterUsageRecordIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) RemoveAdapterUsageRecords(v ...*AdapterUsageRecord) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AdapterRequestsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AdapterRequestsTable,
			Columns: []string{user.AdapterRequestsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.AdapterUsageRecordsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AdapterUsageRecordsTable,
			Columns: []string{user.AdapterUsageRecordsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddAdapterRequestIDs adds the "adapter_requests" edge to the AdapterRequest entity by IDs.
func (_u *UserUpdateOne) AddAdapterRequestIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddAdapterRequestIDs(ids...)
	return _u
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_u *UserUpdateOne) AddAdapterRequests(v ...*AdapterRequest) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddAdapterUsageRecordIDs adds the "adapter_usage_records" edge to the AdapterUsageRecord entity by IDs.
func (_u *UserUpdateOne) AddAdapterUsageRecordIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddAdapterUsageRecordIDs(ids...)
	return _u
}

// AddAdapterUsageRecords adds the "adapter_usage_records" edges to the AdapterUsageRecord entity.
func (_u *UserUpdateOne) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAdapterRequests clears all "adapter_requests" edges to the AdapterRequest entity.
func (_u *UserUpdateOne) ClearAdapterRequests() *UserUpdateOne {
	_u.mutation.ClearAdapterRequests()
	return _u
}

// RemoveAdapterRequestIDs removes the "adapter_requests" edge to AdapterRequest entities by IDs.
func (_u *UserUpdateOne) RemoveAdapterRequestIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveAdapterRequestIDs(ids...)
	return _u
}

// RemoveAdapterRequests removes "adapter_requests" edges to AdapterRequest entities.
func (_u *UserUpdateOne) RemoveAdapterRequests(v ...*AdapterRequest) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAdapterUsageRecords clears all "adapter_usage_records" edges to the AdapterUsageRecord entity.
func (_u *UserUpdateOne) ClearAdapterUsageRecords() *UserUpdateOne {
	_u.mutation.ClearAdapterUsageRecords()
	return _u
}

// RemoveAdapterUsageRecordIDs removes the "adapter_usage_records" edge to AdapterUsageRecord entities by IDs.
func (_u *UserUpdateOne) RemoveAdapterUsageRecordIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveAdapterUsageRecordIDs(ids...)
	return _u
}

// RemoveAdapterUsageRecords removes "adapter_usage_records" edges to AdapterUsageRecord entities.
func (_u *UserUpdateOne) RemoveAdapterUsageRecords(v ...*AdapterUsageRecord) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
