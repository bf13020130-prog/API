...
func (_c *GroupCreate) AddAdapterRequestIDs(ids ...int64) *GroupCreate {
	_c.mutation.AddAdapterRequestIDs(ids...)
	return _c
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_c *GroupCreate) AddAdapterRequests(v ...*AdapterRequest) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *GroupCreate) AddAdapterUsageRecordIDs(ids ...int64) *GroupCreate {
...
func (_c *GroupCreate) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
