...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			adapterprovider.Table:               adapterprovider.ValidColumn,
			adapterrequest.Table:                adapterrequest.ValidColumn,
			adapterusagerecord.Table:            adapterusagerecord.ValidColumn,
