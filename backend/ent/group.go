...
// was not loaded in eager-loading.
func (e GroupEdges) AdapterRequestsOrErr() ([]*AdapterRequest, error) {
	if e.loadedTypes[4] {
...
// was not loaded in eager-loading.
func (e GroupEdges) AdapterUsageRecordsOrErr() ([]*AdapterUsageRecord, error) {
	if e.loadedTypes[5] {
...
// QueryAdapterRequests queries the "adapter_requests" edge of the Group entity.
func (_m *Group) QueryAdapterRequests() *AdapterRequestQuery {
	return NewGroupClient(_m.config).QueryAdapterRequests(_m)
}

// QueryAdapterUsageRecords queries the "adapter_usage_records" edge of the Group entity.
func (_m *Group) QueryAdapterUsageRecords() *AdapterUsageRecordQuery {
	return NewGroupClient(_m.config).QueryAdapterUsageRecords(_m)
}
