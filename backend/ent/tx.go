...
func (tx *Tx) init() {
	...
	tx.AdapterProvider = NewAdapterProviderClient(tx.config)
	tx.AdapterRequest = NewAdapterRequestClient(tx.config)
	tx.AdapterUsageRecord = NewAdapterUsageRecordClient(tx.config)
