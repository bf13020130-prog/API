...
// was not loaded in eager-loading.
func (e UserEdges) AdapterRequestsOrErr() ([]*AdapterRequest, error) {
	if e.loadedTypes[7] {
...
// was not loaded in eager-loading.
func (e UserEdges) AdapterUsageRecordsOrErr() ([]*AdapterUsageRecord, error) {
	if e.loadedTypes[8] {
...
// QueryAdapterRequests queries the "adapter_requests" edge of the User entity.
func (_m *User) QueryAdapterRequests() *AdapterRequestQuery {
	return NewUserClient(_m.config).QueryAdapterRequests(_m)
}

// QueryAdapterUsageRecords queries the "adapter_usage_records" edge of the User entity.
func (_m *User) QueryAdapterUsageRecords() *AdapterUsageRecordQuery {
	return NewUserClient(_m.config).QueryAdapterUsageRecords(_m)
}
