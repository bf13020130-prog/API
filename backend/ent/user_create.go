...
func (_c *UserCreate) AddAdapterRequestIDs(ids ...int64) *UserCreate {
	_c.mutation.AddAdapterRequestIDs(ids...)
	return _c
}

// AddAdapterRequests adds the "adapter_requests" edges to the AdapterRequest entity.
func (_c *UserCreate) AddAdapterRequests(v ...*AdapterRequest) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddAdapterUsageRecordIDs(ids ...int64) *UserCreate {
...
func (_c *UserCreate) AddAdapterUsageRecords(v ...*AdapterUsageRecord) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
